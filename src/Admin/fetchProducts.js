...
//       setNewProduct({ id: '', name: '', productType: '', totalCost: '', itemCost: '', quantity: '' });
//       setTimeout(() => setSuccessMessage(null), 3000);
//     } catch (error) {
...
//                 <td>
//                   <button onClick={() => handleEditProduct(product)} className="admin-button edit-button">
//                     Edit
//                   </button>
//                   <button
