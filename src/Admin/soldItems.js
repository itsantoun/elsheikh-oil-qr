...
const SoldItems = () => {
  ...
  const handleExportToExcel = () => {
    ...
    const exportData = filteredItems.map((item) => ({
      ...
      CustomerID: item.customerId || 'N/A', // Display customer ID
          ...
          <table className="sold-items-table">
            <thead>
              <tr>
                <th>Date</th>
                <th>Customer</th>
                <th>Customer ID</th> {/* Added header for Customer ID */}
                <th>Product Type</th>
                <th>Quantity Sold</th>
                <th>Price</th>
                <th>Item Cost</th>
            ...
            <tbody>
              {filteredItems.map((item) => (
                <tr key={item.id}>
                  ...
                  <td>{customerData[item.customerId]?.name || 'N/A'}</td>
                  <td>{item.customerId || 'N/A'}</td> {/* Display customer ID */}
